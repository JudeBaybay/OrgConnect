...
public class UpdateCc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ccfabm = findViewById(R.id.ccfabm);

        ccfabm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(UpdateCc.this, AddCc.class));
            }
        });
    }
