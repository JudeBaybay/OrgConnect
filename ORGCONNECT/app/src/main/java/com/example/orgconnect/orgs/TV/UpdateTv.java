...
public class UpdateTv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvfabm = findViewById(R.id.tvfabm);

        tvfabm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(UpdateTv.this, AddTv.class)); }
        });
    }
