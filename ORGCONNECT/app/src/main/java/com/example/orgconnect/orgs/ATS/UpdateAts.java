...
public class UpdateAts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        atsfabm = findViewById(R.id.atsfabm);

        atsfabm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(UpdateAts.this, AddAts.class));
            }
        });
    }
