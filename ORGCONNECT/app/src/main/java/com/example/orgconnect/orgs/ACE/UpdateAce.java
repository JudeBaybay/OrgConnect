...
public class UpdateAce extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        acefabm = findViewById(R.id.acefabm);

        acefabm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(UpdateAce.this, AddAce.class));
            }
        });
    }
