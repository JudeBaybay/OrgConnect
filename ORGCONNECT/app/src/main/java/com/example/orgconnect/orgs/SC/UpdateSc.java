...
public class UpdateSc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scfabm = findViewById(R.id.scfabm);

        scfabm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(UpdateSc.this, AddSc.class));
            }
        });
