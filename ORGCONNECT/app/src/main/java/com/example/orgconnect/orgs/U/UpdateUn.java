...
import com.example.orgconnect.faculty.TeacherAdapter;
...
public class UpdateUn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unfabm = findViewById(R.id.unfabm);

        unfabm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(UpdateUn.this, AddUn.class));
            }
        });
    }
        ...
        dbRef1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    adapter1 = new TeacherAdapter(listT8, UpdateUn.this, "Unleashed Adviser");
