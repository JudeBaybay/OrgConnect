...
public class UpdateSums extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sumsfabm = findViewById(R.id.sumsfabm);

        sumsfabm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(UpdateSums.this, AddSums.class)); }
        });
    }
