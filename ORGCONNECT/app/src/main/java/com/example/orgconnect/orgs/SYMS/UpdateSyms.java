...
public class UpdateSyms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        symsfabm = findViewById(R.id.symsfabm);

        symsfabm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(UpdateSyms.this, AddSyms.class)); }
        });
    }
