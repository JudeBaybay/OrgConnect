...
public class UpdatePns extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pnsfabm = findViewById(R.id.pnsfabm);

        pnsfabm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(UpdatePns.this, AddPns.class));
            }
        });
    }
