...
public class AddFaculty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] items = new String[]{"Select Category", "Student Council Adviser", "HM Society Adviser", "SYMS Adviser", "Computer Society Adviser", "SUMS Adviser", "Pen N' Scroll Adviser", "Athlos Club Adviser", "Unleashed Adviser", "Teatro Versatil Adviser", "Coders Club Adviser", "Ace Club Adviser"};
    ...
    private void checkValidation() {
        ...
        if (name.isEmpty()) {
            ...
            Toast.makeText(this, "Please Provide Teacher Advisor", Toast.LENGTH_SHORT).show();
        } else if (bitmap == null) {
