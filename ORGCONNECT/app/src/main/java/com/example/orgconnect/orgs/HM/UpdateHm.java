...
public class UpdateHm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hmfabm = findViewById(R.id.hmfabm);

        hmfabm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(UpdateHm.this, AddHm.class));
            }
        });
